...
last_name IN ('Matos', 'Taylor') ORDER BY hire_date;
...
SELECT last_name, hire_date FROM employees WHERE hire_date >= '01-JAN-10' AND hire_date < '01-JAN-11';

SELECT last_name, job_id FROM employees WHERE
manager_id IS NULL;

SELECT last_name, salary, commission_pct
FROM employees WHERE commission_pct IS NOT NULL ORDER BY 2 DESC, 3 DESC;
...
FROM employees WHERE
job_id IN ('SA_REP', 'ST_CLERK') AND salary NOT IN (2500, 3500, 7000);
